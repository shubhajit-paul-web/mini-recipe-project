...
const NotFound = () => {
	...
	return (
		<div className="flex flex-col justify-center items-center p-15">
			...
			<button className="mt-8 bg-red-400 text-white font-medium text-lg py-3 px-6 rounded-md transition-all duration-200 shadow-2xl shadow-red-200 hover:bg-red-500 hover:scale-[101%]" onClick={() => navigate("/")}>Go to Home</button>
		</div>
	);
};
